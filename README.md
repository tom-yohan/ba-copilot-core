...
├── personas/      # System prompts / assistant personas
├── templates/     # BA document templates
├── docs/          # Internal documentation and setup notes
├── examples/      # Sanitised example inputs
├── outputs/       # Generated outputs (not committed)
└── workspaces/    # Optional project/client workspaces
